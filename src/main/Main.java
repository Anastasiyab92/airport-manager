...
public class Main {
    public static void main(String[] args) {
        ...
        Ticket ticket1 = new Ticket("A351", "Economy",
                new BigDecimal("123"), passenger1);
        Ticket ticket2 = new Ticket("B500", "Business",
                new BigDecimal("550"), passenger2);
        ...
        Schedule schedule1 = new Schedule(LocalDateTime.of(2024,11,18,10,00));
        Schedule schedule2 = new Schedule(LocalDateTime.of(2024,11,18,8,00));
        ...
        Terminal terminal = new Terminal("Terminal1", new Flight[]{ flight1, flight2 });

        Airline airline = new Airline("Emirates", new Flight[]{ flight1, flight2 });

        Airport airport = new Airport("Dubai International Airport", new Airline[]{ airline},
